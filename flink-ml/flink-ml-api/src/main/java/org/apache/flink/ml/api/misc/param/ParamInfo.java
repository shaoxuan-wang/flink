...
public class ParamInfo<V> {
	...
	public ParamInfo(String name, String description, Class<V> valueClass) {
		this(name, description, true, false, null, null, valueClass);
	}

	public ParamInfo(String name, String description, V defaultValue, Class<V> valueClass) {
		this(name, description, true, true, defaultValue, null, valueClass);
	}

	public ParamInfo(String name, String description, boolean isOptional, Class<V> valueClass) {
		this(name, description, isOptional, false, null, null, valueClass);
	}

	public ParamInfo(String name, String description, boolean isOptional, V defaultValue, Class<V> valueClass) {
		this(name, description, isOptional, true, defaultValue, null, valueClass);
	}

	public ParamInfo(String name, String description, boolean isOptional, V defaultValue, ParamValidator<V> validator, Class<V> valueClass) {
		this(name, description, isOptional, true, defaultValue, validator, valueClass);
	}

	private ParamInfo(String name, String description, boolean isOptional, boolean hasDefaultValue, V defaultValue, ParamValidator<V> validator, Class<V> valueClass) {
		this.name = name;
